...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_CONFIG_SETUP = 7,               /* CONFIG_SETUP  */
  YYSYMBOL_CONN = 8,                       /* CONN  */
  YYSYMBOL_CA = 9,                         /* CA  */
  YYSYMBOL_STRING_ERROR = 10,              /* STRING_ERROR  */
  YYSYMBOL_YYACCEPT = 11,                  /* $accept  */
  YYSYMBOL_statements = 12,                /* statements  */
  YYSYMBOL_statement = 13,                 /* statement  */
  YYSYMBOL_section = 14,                   /* section  */
  YYSYMBOL_section_type = 15,              /* section_type  */
  YYSYMBOL_section_name = 16,              /* section_name  */
  YYSYMBOL_setting = 17,                   /* setting  */
...
{
       0,   103,   103,   105,   106,   110,   111,   115,   129,   134,
     139,   147,   150,   156,   159,   172,   184,   193,   194
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "STRING", "EQ",
  "SPACES", "NEWLINE", "CONFIG_SETUP", "CONN", "CA", "STRING_ERROR",
  "$accept", "statements", "statement", "section", "section_type",
  "section_name", "setting", "value", YY_NULLPTR
};
...
#define yyclearin       (yychar = CONF_PARSER_EMPTY)
...
/* Backward compatibility with an undocumented macro.
   Use CONF_PARSER_error or CONF_PARSER_UNDEF. */
#define YYERRCODE CONF_PARSER_UNDEF
...
#line 92 "parser/parser.y"
            { free(((*yyvaluep).s)); }
#line 1229 "parser/parser.c"
        break;

    case YYSYMBOL_section_name: /* section_name  */
#line 92 "parser/parser.y"
            { free(((*yyvaluep).s)); }
#line 1235 "parser/parser.c"
        break;

    case YYSYMBOL_value: /* value  */
#line 92 "parser/parser.y"
            { free(((*yyvaluep).s)); }
#line 1241 "parser/parser.c"
        break;
...
#define YYPOPSTACK(N)   (yyvsp -= (N), yyssp -= (N))
  ...
  yychar = CONF_PARSER_EMPTY; /* Cause a token to be read.  */
...
yybackup:
  ...
  if (yychar <= CONF_PARSER_EOF)
    {
      yychar = CONF_PARSER_EOF;
      yytoken = YYSYMBOL_YYEOF;
      YYDPRINTF ((stderr, "Now at end of input.\n"));
    }
  else if (yychar == CONF_PARSER_error)
    {
      /* The scanner already issued an error message, process directly
         to error recovery.  But do not keep the error token as
         lookahead, it is too special and may lead us to an endless
         loop in error recovery. */
      yychar = CONF_PARSER_UNDEF;
...
yyreduce:
  ...
  switch (yyn)
    {
  case 7: /* section: section_type section_name  */
...
#line 1529 "parser/parser.c"
  ...
  case 8: /* section_type: CONFIG_SETUP  */
...
#line 1561 "parser/parser.c"
  ...
  case 12: /* section_name: STRING  */
#line 151 "parser/parser.y"
        {
		(yyval.s) = (yyvsp[0].s);
	}
#line 1569 "parser/parser.c"
    break;

  case 14: /* setting: STRING EQ value  */
...
yyerrlab:
  ...
  yytoken = yychar == CONF_PARSER_EMPTY ? YYSYMBOL_YYEMPTY : YYTRANSLATE (yychar);
