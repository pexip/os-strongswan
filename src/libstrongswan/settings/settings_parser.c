...
#line 142 "settings/settings_parser.c"
...
#line 228 "settings/settings_parser.c"
...
#line 248 "settings/settings_parser.c"
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_STRING_ERROR = 9,               /* STRING_ERROR  */
  YYSYMBOL_10_ = 10,                       /* '}'  */
  YYSYMBOL_11_ = 11,                       /* '{'  */
  YYSYMBOL_12_ = 12,                       /* '='  */
  ...
  YYSYMBOL_section_start = 17,             /* section_start  */
  YYSYMBOL_references = 18,                /* references  */
  YYSYMBOL_setting = 19,                   /* setting  */
  YYSYMBOL_value = 20,                     /* value  */
  YYSYMBOL_valuepart = 21                  /* valuepart  */
};
...
static const char *const yytname[] =
{
  ...
  "'='", "$accept", "statements", "statement", "section", "section_start",
  "references", "setting", "value", "valuepart", YY_NULLPTR
};
...
#define yyclearin       (yychar = SETTINGS_PARSER_EMPTY)
...
#define YYBACKUP(Token, Value)                                    \
  do                                                              \
    if (yychar == SETTINGS_PARSER_EMPTY)                                        \
      {                                                           \
        yychar = (Token);                                         \
        yylval = (Value);                                         \
        YYPOPSTACK (yylen);                                       \
...
/* Backward compatibility with an undocumented macro.
   Use SETTINGS_PARSER_error or SETTINGS_PARSER_UNDEF. */
#define YYERRCODE SETTINGS_PARSER_UNDEF
...
yy_symbol_value_print (FILE *yyo,
                       yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, parser_helper_t *ctx)
{
  FILE *yyoutput = yyo;
  YY_USE (yyoutput);
  YY_USE (ctx);
...
yydestruct (const char *yymsg,
            yysymbol_kind_t yykind, YYSTYPE *yyvaluep, parser_helper_t *ctx)
{
  YY_USE (yyvaluep);
  YY_USE (ctx);
  if (!yymsg)
...
#line 105 "settings/settings_parser.y"
            { free(((*yyvaluep).s)); }
#line 1244 "settings/settings_parser.c"
        break;

    case YYSYMBOL_STRING: /* STRING  */
#line 105 "settings/settings_parser.y"
            { free(((*yyvaluep).s)); }
#line 1250 "settings/settings_parser.c"
        break;
...
#line 1256 "settings/settings_parser.c"
        break;

    case YYSYMBOL_section_start: /* section_start  */
#line 107 "settings/settings_parser.y"
            { pop_section(ctx); settings_section_destroy(((*yyvaluep).sec), NULL); }
#line 1262 "settings/settings_parser.c"
        break;
...
#line 1268 "settings/settings_parser.c"
        break;

    case YYSYMBOL_setting: /* setting  */
#line 108 "settings/settings_parser.y"
            { settings_kv_destroy(((*yyvaluep).kv), NULL); }
#line 1274 "settings/settings_parser.c"
        break;

    case YYSYMBOL_value: /* value  */
#line 105 "settings/settings_parser.y"
            { free(((*yyvaluep).s)); }
#line 1280 "settings/settings_parser.c"
        break;

    case YYSYMBOL_valuepart: /* valuepart  */
#line 105 "settings/settings_parser.y"
            { free(((*yyvaluep).s)); }
#line 1286 "settings/settings_parser.c"
        break;
...
#define YYPOPSTACK(N)   (yyvsp -= (N), yyssp -= (N))
  ...
  yychar = SETTINGS_PARSER_EMPTY; /* Cause a token to be read.  */
...
yybackup:
  ...
  if (yychar <= SETTINGS_PARSER_EOF)
    {
      yychar = SETTINGS_PARSER_EOF;
      yytoken = YYSYMBOL_YYEOF;
      YYDPRINTF ((stderr, "Now at end of input.\n"));
    }
  else if (yychar == SETTINGS_PARSER_error)
    {
      /* The scanner already issued an error message, process directly
         to error recovery.  But do not keep the error token as
         lookahead, it is too special and may lead us to an endless
         loop in error recovery. */
      yychar = SETTINGS_PARSER_UNDEF;
...
yyreduce:
  ...
  switch (yyn)
    {
  case 5: /* statement: section  */
#line 128 "settings/settings_parser.y"
        {
		add_section(ctx, (yyvsp[0].sec));
	}
#line 1567 "settings/settings_parser.c"
    break;

  case 6: /* statement: setting  */
#line 132 "settings/settings_parser.y"
        {
		add_setting(ctx, (yyvsp[0].kv));
	}
#line 1575 "settings/settings_parser.c"
    break;

  case 7: /* section: section_start statements '}'  */
#line 139 "settings/settings_parser.y"
        {
		pop_section(ctx);
		(yyval.sec) = (yyvsp[-2].sec);
	}
#line 1584 "settings/settings_parser.c"
    break;

  case 8: /* section_start: NAME '{'  */
#line 147 "settings/settings_parser.y"
        {
		(yyval.sec) = push_section(ctx, (yyvsp[-1].s));
	}
#line 1592 "settings/settings_parser.c"
    break;

  case 9: /* section_start: NAME ":" references '{'  */
...
yyerrlab:
  ...
  yytoken = yychar == SETTINGS_PARSER_EMPTY ? YYSYMBOL_YYEMPTY : YYTRANSLATE (yychar);
